    ...
    <Card className="max-w-2xl">
      ...
      <CardContent>
        ...
        <form className="mt-4 space-y-4" onSubmit={handleSubmit}>
          ...
          {mutation.isError ? <div className="mt-3 rounded-md border border-destructive/30 bg-destructive/10 px-4 py-2 text-sm text-destructive">保存失败，请检查网络后重试。</div> : null}
        </form>
      </CardContent>
    </Card>
  )
